					...
					<div class="join-info">
						<div class="grid join-row">
							...
							<div class="join-input-box">
								<div class="input-box h_script_target4">
									<input type="text" id="user_name" name="user_name" value="" title="이름" placeholder="성함을 입력해 주세요" class="input no_button required" />
								</div>
							</div>
						</div>
						...
						<div class="grid join-row">
							...
							<div class="join-input-box grid">
								<div class="input-box h_script_target1">
									<input type="text" id="user_id" name="user_id" value="" title="아이디" placeholder="아이디를 입력해주세요" class="input no_button" readonly="readonly" />
								</div>
								<div class="">
									<button type="button" class="this_button2 hand">중복확인</button>
								</div>
							</div>
						</div>
						...
						<div class="grid join-row">
							...
							<div class="join-input-box grid">
								<div class="input-box">
									<input type="text" id="mobile" name="mobile" value="" title="휴대폰" placeholder="010-0000-0000" class="input no_button" readonly="readonly" />
								</div>
								<div class="">
