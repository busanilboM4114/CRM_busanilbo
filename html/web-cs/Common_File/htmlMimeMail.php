...
include_once $_SERVER['DOCUMENT_ROOT'].'/html/web-cs/Common_File/mimePart.php';
...
*/
	...
	function htmlMimeMail(){
        ...
        */
		...
		$this->build_params['html_charset']  = 'EUC-KR';
		$this->build_params['text_charset']  = 'EUC-KR';
		$this->build_params['head_charset']  = 'EUC-KR';
...
*/
	function setTextCharset($charset = 'EUC-KR')
	{
...
*/
	function setHtmlCharset($charset = 'EUC-KR')
	{
...
*/
	function setHeadCharset($charset = 'EUC-KR')
	{
...
*/
	function _encodeHeader($input, $charset = 'EUC-KR')
	{
