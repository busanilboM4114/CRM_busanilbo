...
if($modes=='write')
{
	$error_link='?mode=write&menu='.$menu.'&tn='.$tn.'&search_select='.$search_select.'&keyword='.@htmlspecialchars($keyword).'&pagenum='.$pagenum.'&board_idx='.$board_idx;//실패 후 이동 경로
	$success_link='?menu='.$menu.'&tn='.$tn.'&mode=list&board_idx='.$board_idx;//성공 후 이동 경로
}
else if($modes=='modify')
{
	$error_link='?menu='.$menu.'&tn='.$tn.'&mode=read&idx='.$idx.'&search_select='.$search_select.'&keyword='.@htmlspecialchars($keyword).'&pagenum='.$pagenum.'&board_idx='.$board_idx;//실패 후 이동 경로
	$success_link='?menu='.$menu.'&tn='.$tn.'&mode=read&idx='.$idx.'&search_select='.$search_select.'&keyword='.@htmlspecialchars($keyword).'&pagenum='.$pagenum.'&board_idx='.$board_idx;//성공 후 이동 경로
}
else if($modes=='delete')
{
	$error_link='?menu='.$menu.'&tn='.$tn.'&mode=read&idx='.$idx.'&search_select='.$search_select.'&keyword='.@htmlspecialchars($keyword).'&pagenum='.$pagenum.'&board_idx='.$board_idx;//실패 후 이동 경로
	$success_link='?menu='.$menu.'&tn='.$tn.'&mode=list&search_select='.$search_select.'&keyword='.@htmlspecialchars($keyword).'&pagenum='.$pagenum.'&board_idx='.$board_idx;//성공 후 이동 경로
}
else if($modes=='alldel')
{
	$error_link='?menu='.$menu.'&tn='.$tn.'&mode=list&search_select='.$search_select.'&keyword='.@htmlspecialchars($keyword).'&pagenum='.$pagenum.'&board_idx='.$board_idx;//실패 후 이동 경로
	$success_link='?menu='.$menu.'&tn='.$tn.'&mode=list&search_select='.$search_select.'&keyword='.@htmlspecialchars($keyword).'&pagenum='.$pagenum.'&board_idx='.$board_idx;//성공 후 이동 경로
}
else
{
...
switch($modes)
{
	case 'write':
		...
		$val['board_idx']		= $target_board_idx;
